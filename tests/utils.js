/*
|
| This code was taken from Alpine.js
| https://github.com/alpinejs/alpine/tree/main/tests/cypress
|
| Thanks @Alpine_JS and @calebporzio
|
*/
...
export let haveData =
  (key, value) =>
  ([el]) =>
    expect(root(el)._x_dataStack[0][key]).to.equal(value)
